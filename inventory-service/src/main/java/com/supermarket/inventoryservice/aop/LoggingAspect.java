package com.supermarket.inventoryservice.aop;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.supermarket.inventoryservice.controller..*)")
    public void controllerLayer() {
    }

    @Pointcut("within(com.supermarket.inventoryservice.service..*)")
