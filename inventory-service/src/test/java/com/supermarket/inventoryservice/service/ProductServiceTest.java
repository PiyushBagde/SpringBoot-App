...
class ProductServiceTest {
    ...
    void reduceStock_WhenSufficientStock_ShouldReduceAndSave() {
        ...
        // Act
        assertDoesNotThrow(() -> productService.reduceStock(prodId, quantityToReduce));
    ...
    void reduceStock_WhenQuantityNotPositive_ShouldThrowIllegalArgumentException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            productService.reduceStock(prodId, 0);
        });
        assertThrows(IllegalArgumentException.class, () -> {
            productService.reduceStock(prodId, -5);
        });
    ...
    void reduceStock_WhenProductNotFound_ShouldThrowResourceNotFoundException() {
        ...
        // Act & Assert
        assertThrows(ResourceNotFoundException.class, () -> {
            productService.reduceStock(prodId, 10);
        });
        verify(productRepository).findById(prodId);
        verify(productRepository, never()).save(any(Product.class));
    }
    ...
    void reduceStock_WhenStockInsufficient_ShouldThrowInsufficientStockException() {
        ...
        assertThrows(InsufficientStockException.class, () -> {
            productService.reduceStock(prodId, quantityToReduce);
        });
        verify(productRepository).findById(prodId);
        verify(productRepository, never()).save(any(Product.class));
    }
    ...
    void updateProduct_WhenValid_ShouldUpdateAndReturnProduct() {
        ...
        // Act
        Product result = productService.updateProduct(prodId, updateRequest);
    ...
    void updateProduct_WhenProductNotFound_ShouldThrowResourceNotFoundException() {
        ...
        // Act & Assert
        assertThrows(ResourceNotFoundException.class, () -> {
            productService.updateProduct(prodId, updateRequest);
        });
        verify(productRepository).findById(prodId);
    ...
    void updateProduct_WhenInvalidInput_ShouldThrowIllegalArgumentException() {
        ...
        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> productService.updateProduct(prodId, invalidPrice));
        assertThrows(IllegalArgumentException.class, () -> productService.updateProduct(prodId, invalidStock));
        assertThrows(IllegalArgumentException.class, () -> productService.updateProduct(prodId, invalidName));
    ...
    void getCategoryByProduct_WhenProductFound_ShouldReturnCategory() {
        ...
        // Act
        Category result = productService.getCategoryByProduct(prodId);
    ...
    void getCategoryByProduct_WhenProductNotFound_ShouldThrowResourceNotFoundException() {
        ...
        // Act & Assert
        assertThrows(ResourceNotFoundException.class, () -> {
            productService.getCategoryByProduct(prodId);
        });
        verify(productRepository).findById(prodId);
    }
    ...
    void updateQuantity_WhenValid_ShouldUpdateStock() {
        ...
        // Act
        Product result = productService.updateQuantity(productId, newQuantity);
    ...
    void updateQuantity_WhenProductNotFound_ShouldThrowResourceNotFoundException() {
        ...
        // Act & Assert
        assertThrows(ResourceNotFoundException.class, () -> productService.updateQuantity(productId, newQuantity));
        verify(productRepository).findById(productId);
        verify(productRepository, never()).save(any(Product.class));
    }
    ...
    void updateQuantity_WhenNegativeQuantity_ShouldThrowIllegalArgumentException() {
        ...
        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> productService.updateQuantity(productId, -5));
        verify(productRepository, never()).findById(anyInt());
        verify(productRepository, never()).save(any(Product.class));
    }
    ...
    void updateQuantity_WhenSaveFails_ShouldThrowOperationFailedException() {
        ...
        // Act & Assert
        assertThrows(OperationFailedException.class, () -> productService.updateQuantity(productId, newQuantity));
        verify(productRepository).findById(productId);
        verify(productRepository).save(any(Product.class));
    }
    ...
    void deleteProd_WhenProductExists_ShouldDeleteProduct() {
        ...
        // Act
        assertDoesNotThrow(() -> productService.deleteProd(productId));
    ...
    void deleteProd_WhenProductNotFound_ShouldThrowResourceNotFoundException() {
        ...
        // Act & Assert
        assertThrows(ResourceNotFoundException.class, () -> productService.deleteProd(productId));
        verify(productRepository).existsById(productId);
    ...
    void deleteProd_WhenDeleteFails_ShouldThrowOperationFailedException() {
        ...
        // Act & Assert
        assertThrows(OperationFailedException.class, () -> productService.deleteProd(productId));
        verify(productRepository).existsById(productId);
        verify(productRepository).deleteById(productId);
    }
    ...
    void getProductByProdName_WhenProductFound_ShouldReturnProduct() {
        ...
        // Act
        Product result = productService.getProductByProdName(productName);
    ...
    void getProductByProdName_WhenNotFound_ShouldThrowResourceNotFoundException() {
        ...
        // Act & Assert
        assertThrows(ResourceNotFoundException.class, () -> productService.getProductByProdName(productName));
        verify(productRepository).findByProdName(productName);
    }
    ...
    void getProductsByCategoryName_WhenCategoryAndProductsExist_ShouldReturnList() {
        ...
        // Act
        List<Product> result = productService.getProductsByCategoryName(categoryName);
    ...
    void getProductsByCategoryName_WhenCategoryNotFound_ShouldThrowResourceNotFoundException() {
        ...
        // Act & Assert
        assertThrows(ResourceNotFoundException.class, () -> productService.getProductsByCategoryName(categoryName));
        verify(categoryRepository).findByCategoryName(categoryName);
        verify(productRepository, never()).findByCategory(any(Category.class));
    }
